...
| Media | media | media_player | Yes | Own picker item | Type: control_modal, speaker_group, play_pause, previous, next, volume, position, now_playing, cover_art, playlist; Type: default, state; Tile Display: default, progress, play_pause; Tap Action: none, play_pause, seek; Show Track Details; External Source Media Entity; Maximum Volume: 1-100; Speaker Discovery Entity; Label Display: label, status; Top Left Display: icon, volume; Media Content ID / URI; Player Source / Input; Large Media Numbers | Visible |
