...
- **Now Playing** with **Play/Pause** shows playback progress behind the title and artist. The played portion uses the accent color while playing and turns grey when paused. Tap to play or pause; the progress display does not seek. Choose **Track Position** to enable seeking instead.
